...
\begin{figure}
	\centering
	\includegraphics[scale=0.4]{causation_effectuation_pyramid}
...
%In addition, a lot of webshops exist so it should be easy to find other webshops to pay a subscription fee.
